...
// const ProjectStats = ({ anime }: { anime: Anime }) => {
//   return (
...
//           </div>
//           <div className="text-[10px] md:text-xs text-gray-400">Season</div>
//         </div>
//       </div>
//     </div>
//   );
...
// const ProjectDetails = ({ anime }: { anime: Anime }) => {
//   if (!anime) {
//     return (
...
//               <span className="text-white/90 truncate">{anime.title}</span>
//             </div>
//           </div>
...
//                     <span>Status</span>
//                     <span className="text-white/90">{anime.status}</span>
//                   </div>
//                   <div className="flex items-center justify-between text-gray-300">
//                     <span>Rating</span>
//                     <span className="text-white/90">{anime.rating}</span>
//                   </div>
//                   <div className="flex items-center justify-between text-gray-300">
//                     <span>Score</span>
//                     <span className="text-white/90">{anime.score}</span>
//                   </div> */}
...
//                   </p>
//                   <p className="text-gray-500 italic">{anime.title_japanese}</p>
//                   <div className="mt-2">
//                     <span className="text-sm font-medium text-gray-600">
//                       Type:{" "}
//                     </span>
//                     <span className="text-sm text-gray-800">{anime.type}</span>
//                   </div>
//                   <div>
//                     <span className="text-sm font-medium text-gray-600">
//                       Episodes:{" "}
...
const ProjectDetails = ({ item }: ProjectDetailsProps) => {
  // Handle loading/undefined state first
  console.log(item);
  if (!item) {
    return (
